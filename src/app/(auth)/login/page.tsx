  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-margin-mobile relative overflow-hidden bg-mesh-gradient">
      ...
      >
        ...
        <p className="text-center mt-8 text-label-sm font-medium">
          <Link href="/" className="text-text-muted hover:text-primary transition-colors flex items-center justify-center gap-1.5">
